...
class GameHistory:
    ...
    player-to-move perspective at each position.
    """
...
class ReplayBuffer:
    ...
    def sample_batch(
        ...
        Masks are one for real entries and zero for terminal padding.
        """
        if not self.games:
